          ...
          <section className="py-16 bg-warmBeige-50">
            <div className="container mx-auto px-4">
              ...
              {agenCity && renovationInterieure && electricien && (
                <div className="mt-12 bg-white p-6 rounded-lg border shadow-sm max-w-3xl mx-auto">
                  <h3 className="text-xl font-semibold mb-4">
                    {electricien.title} pour {renovationInterieure.title} à {agenCity.name}
                  </h3>
                  <p className="text-warmBeige-700 mb-4">
                    Nos électriciens qualifiés interviennent à {agenCity.name} ({agenCity.postalCode}) et aux alentours pour tous vos projets de {renovationInterieure.title.toLowerCase()}.
                    Spécialistes des installations électriques aux normes, nous garantissons des prestations de qualité pour votre sécurité et votre confort.
                  </p>
                  <div className="flex justify-between items-center">
                    <p className="text-sm text-warmBeige-600">
                      {agenCity.postalCode} - {agenCity.department}
                    </p>
                    <Link 
