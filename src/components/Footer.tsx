...
const Footer = () => {
  return (
    <footer className="bg-warmBeige-800 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="font-serif text-xl font-semibold mb-4">Maison Accueillante</h3>
            <p className="text-warmBeige-200 mb-4">
              Votre partenaire de confiance pour tous vos projets de rénovation depuis 2008.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <span>contact@maisonaccueillante.fr</span>
              </div>
              <div className="flex items-start">
